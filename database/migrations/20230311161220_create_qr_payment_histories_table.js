...
exports.up = (knex) => {
    return knex.schema
        .createTable('qrPaymentHistories', (table) => {
            ...
            table.text('qrCodePaymentURL', 'longtext');
            table.bigint('requestAmount').notNullable();
            table.integer('requestMemo').notNullable();
 ...
 */
exports.down = (knex) => {
    return knex.schema.dropTable('paymentHistories');
};
